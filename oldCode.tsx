...
export default function EditProfile() {
  ...
  const GenderListView = () => {
    return (
      <View className="flex-1 bg-white rounded border border-gray-300">
    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <View className="items-center mt-4">
          <TouchableOpacity onPress={pickImage} className="relative">
            ...
            />
            <View className="absolute right-0 bottom-0 p-2 rounded-full bg-primary">
              {uploadingImage ? (
        ...
        <View className="px-4 mt-6 space-y-6">
            ...
            <View className="flex-row gap-x-4">
              <View className="flex-1">
                <Input
                  ...
                  className="px-4 h-12 border-0 bg-gray-800/40"
                />
              </View>
              <View className="flex-1">
                <Input
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              className="flex-row p-3 space-x-2 h-12 rounded-xl bg-gray-800/40"
            >
          ...
          {isGenderShow && (
            <Pressable
              className="overflow-hidden absolute right-0 left-0 flex-1 justify-center items-center"
          ...
          <View>
            ...
            <Input
              ...
              placeholder="College"
              numberOfLines={1}
              className="px-4 py-3 h-24 align-text-top border-0 bg-gray-800/40"
          ...
          <View>
            ...
            <Input
              value={user.email}
              editable={false}
              className="px-4 h-12 border-0 opacity-50 bg-gray-800/40"
            />
          </View>
          ...
          {/* home town*/}
          {
            <View>
              ...
              <TouchableOpacity
                ...
                className="flex-row items-center p-3 space-x-2 h-12 rounded-xl bg-gray-800/40"
              >
                {Platform.OS == "ios" ? (
          ...
          {/*Share My Live Location */}
          {
            <View className="flex-row mt-4">
              <Text className="mt-2 mr-2 text-sm text-muted-foreground">
                Share My Live Location
              </Text>
              <Switch
          ...
          <View className="mt-8">
            <TouchableOpacity
              ...
              className="py-4 rounded-xl border border-destructive"
            >
          ...
          {isEventLocationShow && (
            <Pressable
              className="overflow-hidden absolute top-0 right-0 bottom-0 left-0 bg-black/40"
          ...
          >
            <View className="flex-1 pt-4 mt-4 border-t border-border">
              <TextInput
                ...
                className="p-4 mx-4 text-base rounded-lg border text-foreground border-border"
            ...
            {showResults && searchResults.length > 0 && (
              <View className="mx-4 rounded-lg border border-border bg-background">
          ...
          <View className="flex-1 bg-white rounded-2xl border border-gray-300">
            <View>
              <Input
                ...
                numberOfLines={1}
                className="px-4 py-3 h-24 align-text-top bg-gray-300 border-0"
                textAlignVertical="top"
              />
            </View>
            <ScrollView className="flex-1">
      ...
      {isTopicsShow && (
        <View className="flex-1 bg-transparent">
          ...
          <View className="flex-1 px-2 mx-4 mb-12 bg-white rounded-2xl border border-gray-300">
            <ScrollView>
              <TopicList
