...
export class SearchService {
  ...
  private sanitizeEvent(event: any): EventResult {
    return {
      ...
      image_urls: Array.isArray(event?.image_urls) ? event.image_urls : undefined,
  ...
  private sanitizeLocation(location: any): LocationResult {
    return {
      ...
      image_urls: Array.isArray(location?.image_urls) ? location.image_urls : undefined,
      external_url: location?.external_url || undefined,
      source: location?.source || 'database',
      type: location?.type || undefined,
      categories: Array.isArray(location?.categories) ? location.categories : undefined,
